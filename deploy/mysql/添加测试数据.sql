...
-- 题目表 (新增了 SPJ 和交互题样例)
INSERT INTO `problem` (`id`, `problem_code`, `title`, `author`, `type`, `judge_mode`, `time_limit`, `memory_limit`, `stack_limit`, `description`, `input`, `output`, `examples`, `hint`, `difficulty`, `auth`, `io_score`, `is_remote`, `source`, `spj_code`, `spj_language`, `spj_time_limit`, `spj_memory_limit`, `spj_stack_limit`, `spj_output_limit`, `spj_protocol`, `interactor_code`, `interactor_language`, `interactor_time_limit`, `interactor_memory_limit`, `interactor_stack_limit`, `interactor_output_limit`, `interactor_protocol`, `is_remove_end_blank`, `open_case_result`, `score_percentage`, `submission_count`, `accepted_count`, `data_version`, `modified_user`) VALUES
(1, 'P1000', 'A+B Problem', 'admin', 0, 'default', 1000, 256, 128, '计算两个整数之和', '输入两个整数a和b，用空格分隔', '输出a+b的值', '[{"input": "1 2", "output": "3"}]', '注意整数范围，可能会超过 32 位整型。', 0, 1, 100, 0, 'HnieOJ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0.00, 50, 40, 1, 'admin'),
(2, 'P1001', '排序', 'admin', 0, 'default', 2000, 256, 128, '给定N个数，将它们从小到大排序', '第一行一个整数N，第二行N个整数', '排序后的N个数，空格分隔', '[{"input": "5\\n3 1 4 2 5", "output": "1 2 3 4 5"}]', '建议使用快速排序 (Quick Sort) 或归并排序 (Merge Sort)。', 1, 1, 100, 0, 'HnieOJ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0.00, 30, 25, 1, 'admin'),
(3, 'P1002', '斐波那契数列', 'teacher1', 1, 'default', 1000, 128, 64, '计算第n项斐波那契数', '输入一个整数n', '输出F(n)的值', '[{"input": "5", "output": "5"}]', 'n不超过30', 0, 1, 100, 0, '经典递归', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0.00, 20, 18, 1, 'teacher1'),
(4, 'P1003', '最大子段和', 'admin', 0, 'default', 1000, 256, 128, '求给定数组的最大连续子段和', '第一行N，第二行N个整数', '最大子段和', '[{"input": "5\\n-2 1 -3 4 -1 2 1 -5 4", "output": "6"}]', '可以使用 Kadane 算法动态规划解决。', 2, 1, 100, 0, 'LeetCode', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0.00, 15, 8, 1, 'admin'),
(5, 'P1004', '字符串反转', 'teacher2', 0, 'default', 500, 64, 32, '输入一个字符串，输出其反转', '一个字符串S', '反转后的字符串', '[{"input": "hello", "output": "olleh"}]', '无', 0, 1, 100, 0, 'HnieOJ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0.00, 25, 23, 1, 'teacher2'),
(6, 'P1005', '素数判断', 'admin', 0, 'default', 1000, 128, 64, '判断一个数是否为素数', '一个整数n', 'Yes 或 No', '[{"input": "7", "output": "Yes"}, {"input": "10", "output": "No"}]', '2 <= n <= 10^9', 1, 1, 100, 0, '数学', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0.00, 40, 30, 1, 'admin'),
(7, 'P1006', '任何符合条件的排列 (SPJ)', 'admin', 0, 'spj', 1000, 256, 128, '给定 N，输出任意一个包含 1 到 N 的排列，要求相邻元素互质。', '输入 N (1<=N<=100)', '输出你的排列，空格隔开', '[{"input": "3", "output": "1 2 3"}]', '答案不唯一，本题采用 Special Judge。', 1, 1, 100, 0, 'HnieOJ', '#include<stdio.h>\n// 简单的特判逻辑...', 'C', 2000, 256, 128, 16777216, 'hnieoj-result-json-v1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0.00, 10, 5, 1, 'admin');
...
INSERT INTO `judge` (`id`, `submit_id`, `judge_task_id`, `problem_id`, `problem_code`, `uid`, `username`, `language`, `code`, `status`, `error_message`, `diagnostic_message`, `time`, `memory`, `score`, `cid`, `total_case`, `judged_case`, `current_case`, `cpid`, `tid`, `hid`, `judger`, `ip`, `is_manual`) VALUES
(1, 's0001', 'task-s0001', 1, 'P1000', '20230003', 'student1', 'C++17', '#include <iostream>\nint main() { int a,b; std::cin>>a>>b; std::cout<<a+b; return 0; }', 0, NULL, NULL, 10, 1024, 100, 0, 1, 1, 1, 0, 0, 0, 'judge-1', '127.0.0.1', 0),
(2, 's0002', 'task-s0002', 2, 'P1001', '20230004', 'student2', 'Python3', 'n=int(input())\na=list(map(int,input().split()))\na.sort()\nprint(*a)', 1, 'Runtime Error', NULL, 50, 2048, 80, 0, 2, 2, 2, 0, 0, 0, 'judge-1', '192.168.1.2', 0),
(3, 's0003', 'task-s0003', 1, 'P1000', '20230009', 'student3', 'Java', 'import java.util.*;\npublic class Main{public static void main(String[] args){Scanner sc=new Scanner(System.in);System.out.println(sc.nextInt()+sc.nextInt());}}', 0, NULL, NULL, 15, 2048, 100, 0, 1, 1, 1, 0, 0, 0, 'judge-2', '10.0.0.5', 0),
(4, 's0004', 'task-s0004', 3, 'P1002', '20230010', 'student4', 'C', '#include <stdio.h>\nint main() { int n; scanf("%d",&n); printf("%d",fib(n)); }', 2, 'Compile Error: function fib not declared.', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 'judge-1', '10.0.0.6', 0),
(5, 's0005', 'task-s0005', 4, 'P1003', '20230011', 'student5', 'C++17', '...', -10, NULL, NULL, NULL, NULL, NULL, 0, 10, 0, 0, 0, 0, 0, NULL, NULL, 0),
(6, 's0006', 'task-s0006', 5, 'P1004', '20230012', 'student6', 'Python3', 'print(input()[::-1])', 0, NULL, NULL, 5, 512, 100, 0, 1, 1, 1, 0, 0, 0, 'judge-2', '192.168.1.3', 0),
(7, 's0007', 'task-s0007', 2, 'P1001', '20230003', 'student1', 'C++17', '...', 3, 'Wrong Answer', NULL, 8, 1024, 50, 1, 2, 2, 2, 1, 0, 0, 'judge-1', '127.0.0.1', 0),
(8, 's0008', 'task-s0008', 7, 'P1006', '20230003', 'student1', 'C++17', '#include <iostream>\nint main(){std::cout<<"1 2 3";}', -8, NULL, NULL, NULL, NULL, NULL, 0, 10, 2, 3, 0, 0, 0, 'judge-1', '127.0.0.1', 0),
(9, 's0009', 'task-s0009', 1, 'P1000', '20230003', 'student1', 'C++17', '#include <iostream>\nint main(){return 0;}', -9, NULL, NULL, NULL, NULL, NULL, 0, 10, 0, 0, 0, 0, 0, 'judge-1', '127.0.0.1', 0);
